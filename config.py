...
WEBAPP_URL = "https://boostixnet.onrender.com/webapp/?v=15"
...
# SMTP settings for sending verification emails (optional)
SMTP_HOST = os.environ.get('SMTP_HOST', '')
SMTP_PORT = int(os.environ.get('SMTP_PORT', os.environ.get('SMTP_PORT', 0)) or 0)
SMTP_USER = os.environ.get('SMTP_USER', '')
SMTP_PASS = os.environ.get('SMTP_PASS', '')
SMTP_FROM = os.environ.get('SMTP_FROM', 'no-reply@local')
